...
namespace FarmaYah.Server.Migrations
{
    ...
    [Migration("20240227015404_Agregando NumSeguroMedicoOpcional")]
    partial class AgregandoNumSeguroMedicoOpcional
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmaYah.Shared.Models.SegurosMedicos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeguroMedicoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 26, 21, 54, 4, 276, DateTimeKind.Local).AddTicks(5783),
                            Nombre = "ARS Humano"
                        },
                        new
                        {
                            SeguroMedicoId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 26, 21, 54, 4, 276, DateTimeKind.Local).AddTicks(5799),
                            Nombre = "ARS Palic"
                        },
                        new
                        {
                            SeguroMedicoId = 3,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 26, 21, 54, 4, 276, DateTimeKind.Local).AddTicks(5801),
