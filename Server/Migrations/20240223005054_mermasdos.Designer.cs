...
namespace FarmaYah.Server.Migrations
{
    ...
    [Migration("20240223005054_mermasdos")]
    partial class mermasdos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmaYah.Shared.Models.SegurosMedicos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeguroMedicoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 22, 20, 50, 54, 525, DateTimeKind.Local).AddTicks(7627),
                            Nombre = "ARS Humano"
                        },
                        new
                        {
                            SeguroMedicoId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 22, 20, 50, 54, 525, DateTimeKind.Local).AddTicks(7645),
                            Nombre = "ARS Palic"
                        },
                        new
                        {
                            SeguroMedicoId = 3,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 22, 20, 50, 54, 525, DateTimeKind.Local).AddTicks(7646),
