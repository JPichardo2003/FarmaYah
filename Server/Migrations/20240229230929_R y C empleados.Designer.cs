...
namespace FarmaYah.Server.Migrations
{
    ...
    [Migration("20240229230929_R y C empleados")]
    partial class RyCempleados
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmaYah.Shared.Models.SegurosMedicos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeguroMedicoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 29, 19, 9, 28, 957, DateTimeKind.Local).AddTicks(3576),
                            Nombre = "ARS Humano"
                        },
                        new
                        {
                            SeguroMedicoId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 29, 19, 9, 28, 957, DateTimeKind.Local).AddTicks(3593),
                            Nombre = "ARS Palic"
                        },
                        new
                        {
                            SeguroMedicoId = 3,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 29, 19, 9, 28, 957, DateTimeKind.Local).AddTicks(3595),
