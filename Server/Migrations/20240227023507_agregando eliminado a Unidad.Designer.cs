...
namespace FarmaYah.Server.Migrations
{
    ...
    [Migration("20240227023507_agregando eliminado a Unidad")]
    partial class agregandoeliminadoaUnidad
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmaYah.Shared.Models.SegurosMedicos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeguroMedicoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 26, 22, 35, 7, 478, DateTimeKind.Local).AddTicks(593),
                            Nombre = "ARS Humano"
                        },
                        new
                        {
                            SeguroMedicoId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 26, 22, 35, 7, 478, DateTimeKind.Local).AddTicks(609),
                            Nombre = "ARS Palic"
                        },
                        new
                        {
                            SeguroMedicoId = 3,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 26, 22, 35, 7, 478, DateTimeKind.Local).AddTicks(611),
