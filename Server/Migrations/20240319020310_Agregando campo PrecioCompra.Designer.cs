...
namespace FarmaYah.Server.Migrations
{
    ...
    [Migration("20240319020310_Agregando campo PrecioCompra")]
    partial class AgregandocampoPrecioCompra
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmaYah.Shared.Models.SegurosMedicos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeguroMedicoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 3, 18, 22, 3, 9, 924, DateTimeKind.Local).AddTicks(6583),
                            Nombre = "ARS Humano"
                        },
                        new
                        {
                            SeguroMedicoId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 3, 18, 22, 3, 9, 924, DateTimeKind.Local).AddTicks(6599),
                            Nombre = "ARS Palic"
                        },
                        new
                        {
                            SeguroMedicoId = 3,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 3, 18, 22, 3, 9, 924, DateTimeKind.Local).AddTicks(6601),
