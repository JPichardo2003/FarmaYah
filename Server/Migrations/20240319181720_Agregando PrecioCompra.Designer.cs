...
namespace FarmaYah.Server.Migrations
{
    ...
    [Migration("20240319181720_Agregando PrecioCompra")]
    partial class AgregandoPrecioCompra
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FarmaYah.Shared.Models.SegurosMedicos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeguroMedicoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 3, 19, 14, 17, 19, 739, DateTimeKind.Local).AddTicks(7510),
                            Nombre = "ARS Humano"
                        },
                        new
                        {
                            SeguroMedicoId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 3, 19, 14, 17, 19, 739, DateTimeKind.Local).AddTicks(7528),
                            Nombre = "ARS Palic"
                        },
                        new
                        {
                            SeguroMedicoId = 3,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 3, 19, 14, 17, 19, 739, DateTimeKind.Local).AddTicks(7530),
