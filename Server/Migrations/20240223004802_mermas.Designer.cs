...
namespace FarmaYah.Server.Migrations
{
    ...
    [Migration("20240223004802_mermas")]
            ...
            modelBuilder.Entity("FarmaYah.Shared.Models.SegurosMedicos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SeguroMedicoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 22, 20, 48, 2, 393, DateTimeKind.Local).AddTicks(1324),
                            Nombre = "ARS Humano"
                        },
                        new
                        {
                            SeguroMedicoId = 2,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 22, 20, 48, 2, 393, DateTimeKind.Local).AddTicks(1345),
                            Nombre = "ARS Palic"
                        },
                        new
                        {
                            SeguroMedicoId = 3,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 2, 22, 20, 48, 2, 393, DateTimeKind.Local).AddTicks(1347),
